...
fun WalliesFavoriteButton(
    ...
    val favoriteItemState = rememberUpdatedState(favoriteImages)
    ...
    IconButton(
        ...
        val tintColor =
            if (favoriteItemState.value?.isChecked?.or(isClicked) == true) Red else MaterialTheme.colorScheme.onPrimaryContainer
        Icon(
